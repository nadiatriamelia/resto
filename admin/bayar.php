<?php
    ...
    if($aksi=='bayar'){
        ...
        $update = $dbo->update("tblorder", "total = $total, diskon=$diskon,pajak=$pajak, bayar='$bayar',kembali=$kembalian", "idorder=".$_GET['idorder']);
            if($update){
                 ?>
                <script>
...
<?php
    ...
    ?>
    <div class="data">    
    <table style="witdh:60% margin:auto;margin-top:100x" cellspancing="0" cellpadding="0">
        <tr>
            <th>No</th>
            <th>Nama Menu</th>
            <th>Jumlah</th>
